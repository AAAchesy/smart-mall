    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in commentList" :key="item.comment_id">
          <div class="top">
            <img :src="item.user.avatar_url || defaultAvataur" alt="">
...
import defaultAvataur from '@/assets/default-avatar.png'
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      const { data } = await addCart(this.goodsId, this.proCount, this.detail.skuList[0].goods_sku_id)
